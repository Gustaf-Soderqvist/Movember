...
//    {
//        public static void InitializeUserData(IServiceProvider serivceProviderUser)
//        {
//            var Usercontext = serivceProviderUser.GetService<IzMovemberContext>();
...
//                   Usercontext.SaveChanges().Distinct(new UniqueUserByEmail());
//            }
...
////public void SeedInfoZoners()
////{
////    var infozoners = new List<User> {
...
////            new User { Name = "Ulf Rundqvist", Email = "ulf.rundqvist @infozone.se" },
////            new User { Name = "Viktor Blomqvist", Email = "viktor.blomqvist @infozone.se" }
////            }.Distinct(new UniqueUserByEmail());
////}
